...
class LibraryService {
	...
	static void createEncyclopedia() {
		System.out.print("TITLE: ");
		String title = sc.nextLine();
	...
	static void readMagazine() {
		LibraryDB.readMagazineDB();
	}

	static void readNewspaper() {
		LibraryDB.readNewspaperDB();
	}

	static void readEncyclopedia() {
		LibraryDB.readEncyclopediaDB();
	}

	static void readComic() {
	...
	static void updateEncyclopedia() {
