...
class LibraryDB {
	...
	static void createBookDB(Book book) {
	...
	static void createMagazineDB(Magazine magazine) {
		try (Connection connection = libraryConnection.getConnection()) {
			try {
	...
	static void createNewspaperDB(Newspaper newspaper) {
		try (Connection connection = libraryConnection.getConnection()) {
			try {
	...
	static void createEncyclopediaDB(Encyclopedia encyclopedia) {
		try (Connection connection = libraryConnection.getConnection()) {
			try {
	...
	static void createComicDB(Comic comic) {
		try (Connection connection = libraryConnection.getConnection()) {
			try {
	...
	static void readEncyclopediaDB() {
		int i = 0;
		System.out.println("\n==========================================");
	...
	static void updateBookDB(Book book, int option) {
		try (Connection connection = libraryConnection.getConnection()) {
			try {
				switch (option) {
					case 1:
	...
	static void updateMagazineDB(Magazine magazine, int option) {
		try (Connection connection = libraryConnection.getConnection()) {
			try {
				switch (option) {
					case 1:
	...
	static void updateNewspaperDB(Newspaper newspaper, int option) {
		try (Connection connection = libraryConnection.getConnection()) {
			try {
				switch (option) {
					case 1:
	...
	static void updateEncyclopediaDB(Encyclopedia encyclopedia, int option) {
		try (Connection connection = libraryConnection.getConnection()) {
			try {
				switch (option) {
					case 1:
	...
	static void updateComicDB(Comic comic, int option) {
		try (Connection connection = libraryConnection.getConnection()) {
			try {
				switch (option) {
					case 1:
	...
	static void deleteBookDB(int idBook) {
		try (Connection connection = libraryConnection.getConnection()) {
			try {
	...
	static void deleteMagazineDB(int idMagazine) {
		try (Connection connection = libraryConnection.getConnection()) {
			try {
	...
	static void deleteNewspaperDB(int idNewspaper) {
		try (Connection connection = libraryConnection.getConnection()) {
			try {
	...
	static void deleteEncyclopediaDB(int idEncyclopedia) {
		try (Connection connection = libraryConnection.getConnection()) {
			try {
	...
	static void deleteComicDB(int idComic) {
		try (Connection connection = libraryConnection.getConnection()) {
			try {
